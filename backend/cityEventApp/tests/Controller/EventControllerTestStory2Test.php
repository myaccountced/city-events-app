...
class EventControllerTestStory2Test extends KernelTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->eventController = new EventController($this->eventRepo, $this->jwtManager, $mailerMock, $entityManager);
    }
    ...
    public function testExpandEventRequiredOnly()
    {
        ...
        $mailerMock = $this->createMock(MailerInterface::class);
        $eventController = new EventController($eventRepo, $this->jwtManager, $mailerMock, $entityManager);
